	...
	FXMainPane() {
	    ...
	    encryption.setOnAction(event -> {
	    	try {
				...
				System.out.println(inputForEncryptionTextField.getText()+" Characters entered must have ASCII codes from 32 to 95. Also, remember to enter an incription key.");	
			}
		});
